...
Docker와 [OpenClaw](https://github.com/openclaw/openclaw)를 사용해서 나만의 AI 텔레그램 봇을 만드는 퀵스타트 가이드입니다. Clone하고, 토큰 두 개만 넣으면 바로 동작합니다.
...
| **AI API Key** | OpenAI, Anthropic, Google Gemini, 또는 OpenRouter 중 하나의 API 키 |
...
끝! 이제 Telegram에서 만든 봇에게 메시지를 보내보세요.
...
기본 모델은 **OpenAI gpt-4o-mini**입니다. 다른 AI를 사용하려면:

### Provider 비교

| Provider | 모델 | `.env` 변수 | 가격 |
|----------|------|-------------|------|
| **OpenAI** | gpt-4o-mini | `OPENAI_API_KEY` | $ |
| **Anthropic** | Claude Sonnet 4.6 | `ANTHROPIC_API_KEY` | $$ |
| **Google** | Gemini 2.0 Flash | `GEMINI_API_KEY` | $ |
| **OpenRouter** | 여러 모델 지원 | `OPENROUTER_API_KEY` | 모델마다 상이 |
